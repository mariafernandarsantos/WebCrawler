...
class WhatsappBot:
    ...
    def enviar_mensagens(self):
        ...
        for grupo in self.grupos:
            grupo = self.driver.find_element(by=By.XPATH, value='//*[@id="pane-side"]/div/div/div/div[1]/div/div/div/div[2]/div[1]/div[1]/span')
            time.sleep(3)
            grupo.click()
        ...
        salvar_noticias_enviadas(noticias_enviadas)

# Criar uma instância do WhatsappBot
bot = WhatsappBot()

# Agendar a execução do bot para um horário específico (por exemplo, todos os dias às 10:00 da manhã)
schedule.every().day.at("10:39").do(bot.enviar_mensagens)
